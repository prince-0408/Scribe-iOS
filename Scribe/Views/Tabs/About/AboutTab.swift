...
/**
 * The About tab for the Scribe - Language Keyboards app.
 */
...
struct AboutTab: View {
    ...
    private func resetAppHints() {
        ...
        defaults.set(true, forKey: "installationTipCardState")
        defaults.set(true, forKey: "settingsTipCardState")
        defaults.set(true, forKey: "aboutTipCardState")
