...
struct AboutInfoView: View {
    ...
    private var bodyText: String {
        switch section {
        case .wikimedia:
            return scribeKeyboardWikimediaBodyText
        case .privacyPolicy:
            return scribeKeyboardPrivacyPolicyBodyText
        case .licenses:
            return scribeKeyboardThirdPartyLicensesBodyText
        }
    }
...
private let scribeKeyboardWikimediaBodyText: String = {
...
private let scribeKeyboardPrivacyPolicyBodyText: String = NSLocalizedString(
...
private let scribeKeyboardThirdPartyLicensesBodyText: String = {
